...
int main()
{
    ...
    cout << "smallest long double:  " << numeric_limits<long double>::min()
         << endl;
    ...
    // from float.h
    cout << "FLT_DIG (float no. of decimal digits precision):  " << FLT_DIG
         << endl;
    cout << "DBL_DIG (double no. of decimal digits precision):  " << DBL_DIG
         << endl;
