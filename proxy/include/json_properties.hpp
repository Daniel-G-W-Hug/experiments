...
// redefine MACRO since original macro uses nlohmann::json as default instead of
...
struct window : public property
{
    size s;

    void parse_from_json(json const& j);
    std::string get_id() const override { return "window"s; }
};

std::ostream& operator<<(std::ostream& os, const window& w);

struct font : public property
{
    ...
    void parse_from_json(json const& j);
    std::string get_id() const override { return "font"s; }
};

std::ostream& operator<<(std::ostream& os, const font& f);

struct circle : public property
{
    ...
    void parse_from_json(json const& j);
    std::string get_id() const override { return "circle"s; }
};

std::ostream& operator<<(std::ostream& os, const circle& c);

struct rectangle : public property
{
    std::string name{}; // display name
    position pos;       // position
    speed spd;          // speed
    ...
    void parse_from_json(json const& j);
    std::string get_id() const override { return "rectangle"s; }
};
